...
if __name__ == '__main__':
    ...
    input_cfg_path = 'cfg.gpickle'
    input_call_graph_path ='cg.gpickle'
    ...
    output_path = 'test/unchecked external call (UC)/cfg_cg_compressed_graphs.gpickle'
    ...
    nx.nx_agraph.write_dot(merged_graph, 'merger.dot')